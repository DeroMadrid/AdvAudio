...
def train(args, train_dir_, validation_dir_, summary_dir_, model_dir_, train_tran_txt_, validation_tran_txt_,
...
def mains():
    ...
    parser.set_defaults(
        ...
        model_path="./result/recaptcha/11-29-10-48_wgan-gp/model",
    ...
    # result_dir = os.path.join("./result/recaptcha/11-29-10-45_wgan-gp")
    result_dir = os.path.join("./result/recaptcha/11-29-10-48_wgan-gp")
   ...
   #  config_file = "/media/ps/data/gxy/Adv_audio/jasper_test.py"
    ...
    train(args, train_dir, validation_dir, summary_dir, model_dir, train_tran_txt, validation_tran_txt,
           result_dir)
