...
from OpenSeq2Seq.open_seq2seq.parts.transformer.utils import get_padding_bias, get_padding
from OpenSeq2Seq.open_seq2seq.parts.convs2s import ffn_wn_layer, conv_wn_layer
