...
def lingvoCall(audios_np_, tgt_np_, tran_d_, sr_, masks_freq_, audio_data_maxlen_, freq_maxlen_,
...
if __name__ == "__main__":
    ...
    tran_d_l_txt = "/media/ps/data/gxy/Adv_audio/data/recaptchaV2/org200/tran_d_l.txt"
    lv_main(tran_d_txt, audio_dir, tran_d_l_txt)
