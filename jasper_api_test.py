...
def call_jasper(config_file, audios_, tgts_, audio_data_maxlen_, tran_save_txt_):
    batch_size = 1
...
def js_main(config_file, audio_dir_, tran_txt_=None, tran_j_txt_=None):
    ...
    call_jasper(config_file, audios, tgts, audio_data_maxlen, tran_save_txt_= result_txt)


if __name__ == "__main__":
    # audio_dir = "/media/ps/data/gxy/Adv_audio/result/recaptcha/11-29-10-45_wgan-gp/test/adv_audio"
    # result_txt = "/media/ps/data/gxy/Adv_audio/result/recaptcha/11-29-10-45_wgan-gp/test/adv_jasper.txt"
    audio_dir = "/media/ps/data/gxy/Adv_audio/result/recaptcha/11-29-10-48_wgan-gp/test/adv_audio"
    result_txt = "/media/ps/data/gxy/Adv_audio/result/recaptcha/11-29-10-48_wgan-gp/test/adv_jasper.txt"
    config_file = "/media/ps/data/gxy/Adv_audio/jasper_test.py"
    js_main(config_file, audio_dir, result_txt)
